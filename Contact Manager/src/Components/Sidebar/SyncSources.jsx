  ...
  return (
    <div className="p-3 bg-gray-900 rounded-xl">
      <div className="flex justify-between mb-4 rounded-tl-3xl rounded-tr-3xl">
        <div className="flex items-center justify-between gap-3 w-full shadow-sm shadow-black py-3 px-2 rounded-full hover:bg-blue-600">
          <h2 className="text-white text-base md:text-lg font-semibold w-full gap-5">
            Synced Sources
          </h2>
      ...
      {isExpanded && (
        <div className="text-white">
          {SyncedData.map(({ id, name, totalNum }) => (
            <div
              key={id}
